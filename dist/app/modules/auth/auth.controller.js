...
const getAccessToken = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!refreshToken) {
        throw new appError_1.default(404, "Refresh Token not found.");
    }
    const result = yield auth_service_1.AuthServices.getAccessToken(refreshToken);
    (0, setCookies_1.setAuthCookies)(res, result.data);
    (0, sendResponse_1.SendResponse)(res, {
        statusCode: 200,
        success: true,
        message: "User Loged in successfully",
...
const setPassword = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const decodedToken = req.user;
    yield auth_service_1.AuthServices.setPassword(decodedToken.userId, req.body);
    (0, sendResponse_1.SendResponse)(res, {
        statusCode: 200,
        success: true,
...
const googleAuthCallback = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    ...
    const result = (0, createUserToken_1.createUserToken)(user);
    (0, setCookies_1.setAuthCookies)(res, result);
